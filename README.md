...
* python3 ofer.py slow proxy — медленные запросы с паузой и размазанным трафиком с авто проксированием.
* python3 ofer.py slow proxy — высокая интенсивность, меньше задержка и больше параллельных воркеров с авто проксированием.
* python3 ofer.py slow proxy - резанансные запросы через открытие сессии с авто проксированием.
